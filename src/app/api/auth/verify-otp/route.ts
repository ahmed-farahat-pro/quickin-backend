...
// and returns { token, user } (also sets the qk_token cookie for web). `user` carries
// the same host fields as /api/auth/me so the new session is correct immediately.
