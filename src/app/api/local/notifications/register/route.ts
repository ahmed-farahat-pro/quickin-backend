...
// Alias of /register-device — the iOS app calls PATCH /api/local/notifications/register
// { fcm_token, token, platform }. Stores the device's FCM/APNs token for the
// signed-in user so push can be delivered.
