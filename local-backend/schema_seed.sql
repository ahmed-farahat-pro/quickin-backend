-- =============================================================================
-- QuickIn LOCAL (no Supabase) — plain PostgreSQL schema + dummy data
-- Run against the quickin_local database.
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- Seed 8 boutique stays with real coordinates + photos
-- ---------------------------------------------------------------------------
DO $$
DECLARE
  v_id uuid;
...
BEGIN
  FOR i IN 1 .. array_length(rows_arr,1) LOOP
    ...
    VALUES (
      rows_arr[i][1], rows_arr[i][2], rows_arr[i][3], rows_arr[i][4],
...
SELECT count(*) AS images FROM listing_images;
